...
if strcmp(Period,'1980-2000')
    file = ['J:\D\UKCP18\',region.Name,'\',sprintf('Ensems_%s_mon%02d.mat',ENSEMBLENO,MON)];
elseif strcmp(Period,'2020-2040')
    file = ['J:\D\UKCP18_Future\',region.Name,'\',sprintf('Ensems_%s_mon%02d.mat',ENSEMBLENO,MON)];
elseif strcmp(Period,'2060-2080')
    file = ['J:\D\UKCP18_Future_2060_2080\',region.Name,'\',sprintf('Ensems_%s_mon%02d.mat',ENSEMBLENO,MON)];
elseif strcmp(Period,'2007-2018') % && strcmp(ENSEMBLENO,'RAD')
    file = ['J:\D\UKCP18\',region.Name,'\',sprintf('Radar_mon%02d.mat',MON)];
end
...
saveIt = struct;
saveIt.path = 'J:\D\UKCP18\ConvectiveStorms';
