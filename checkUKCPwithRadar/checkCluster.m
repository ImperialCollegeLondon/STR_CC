...
for enNo = 12:length(ENSEMBLENO)
    ...
    save(['D:/UKCP18/CPM_4d4_Ensno',ENSEMBLENO{enNo},'_JJA_pJJAp2_RipletK2.mat'],...
        'AK_NC','AK','RadVec');
end


% run('H:\CODE_MATLAB\SpatialTemporalDATA\checkUKCPwithRadar\checkCluster_Radar.m')
