...
% save data in a suitable data type
% According to the format described in NIMROD format file. (Accessed from BADC)
rr_dat_mat = int16(rr_dat_mat');
int_gen_hd = int16(int_gen_hd);
rl_gen_hd = int32(rl_gen_hd);
rl_datsp_hd = int32(rl_datsp_hd);
int_datsp_hd = int16(int_datsp_hd);
