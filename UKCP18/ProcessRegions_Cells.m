...
LetItRun(dataSP,REGIONS.SWestuk);

LetItRun(dataSP,REGIONS.Westuk);

LetItRun(dataSP,REGIONS.Scotland);

LetItRun(dataSP,REGIONS.London);
...
for season = 1:4
    ...
    [E,N,RainEnsembles,scaleF,region] = loadRainEnsembles(region,getMons(season));
